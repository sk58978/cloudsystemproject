...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function loadCart() {
        try {
            ...
            <div class="cart-item" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; padding:10px; border:1px solid #ddd; border-radius:5px;">
              ...
              <div style="display:flex; align-items:center; gap:8px;">
                ...
                <button class="btn-remove"
                        data-id="${item.product_id}"
                        style="color:red; background:none; border:none; text-decoration:underline; font-size:12px; cursor:pointer;">
                  Usuń
                </button>
              </div>
            </div>
